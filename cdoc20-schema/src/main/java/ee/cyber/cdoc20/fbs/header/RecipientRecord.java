...
public final class RecipientRecord extends Table {
  ...
  public int encryptedFmk(int j) { int o = __offset(10); return o != 0 ? bb.get(__vector(o) + j * 1) & 0xFF : 0; }
  public int encryptedFmkLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public ByteVector encryptedFmkVector() { return encryptedFmkVector(new ByteVector()); }
  public ByteVector encryptedFmkVector(ByteVector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), bb) : null; }
  public ByteBuffer encryptedFmkAsByteBuffer() { return __vector_as_bytebuffer(10, 1); }
  public ByteBuffer encryptedFmkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 10, 1); }
  ...
  public static void addFmkEncryptionMethod(FlatBufferBuilder builder, byte fmkEncryptionMethod) { builder.addByte(4, fmkEncryptionMethod, 0); }
  public static int endRecipientRecord(FlatBufferBuilder builder) {
    int o = builder.endTable();
    builder.required(o, 8);  // key_label
    builder.required(o, 10);  // encrypted_fmk
    return o;
  }
